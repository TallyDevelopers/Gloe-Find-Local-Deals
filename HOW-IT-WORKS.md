...
- **Welcome** — once, the moment your account is first created (never on later logins). Unlike the others, it's **not branded at all** — it's a plain personal note from "Ryan at Gloē," like the founder typed it. That's deliberate: branded layouts with buttons get filed under Gmail's Promotions tab, plain personal notes land in Primary. Still static (no listings, no prices, nothing that goes stale): the premium pitch, a warm you're-early line, and a plain link to the location-aware discover page.
